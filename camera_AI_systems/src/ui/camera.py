...
class CameraPage(QWidget):
    ...
    def update_grid_layout(self):
        ...
        # Set up new grid for 2x2 layout
        rows, cols = 2, 2  # Thay đổi số hàng và cột thành 2x2
        ...
        total_width = cols * 640  # Cập nhật chiều rộng
        total_height = rows * 640  # Cập nhật chiều cao
